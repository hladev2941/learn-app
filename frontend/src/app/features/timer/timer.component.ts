  ...
  template: `
    <div class="page">
      <div class="page-header">
        <div class="page-icon" style="background:linear-gradient(135deg,#f59e0b,#fbbf24)">
      ...
      <div class="empty-card">
        <div class="empty-icon" style="background:linear-gradient(135deg,rgba(245,158,11,0.12),rgba(251,191,36,0.08))">
          <mat-icon style="color:#f59e0b">timer</mat-icon>
        </div>
        <p class="empty-title">Tính năng đang phát triển</p>
        <p class="empty-desc">Hẹn giờ Pomodoro tích hợp theo dõi thời gian học sẽ sớm ra mắt.</p>
      </div>
    </div>
  `,
})
