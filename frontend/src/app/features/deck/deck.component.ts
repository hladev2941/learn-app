  ...
  template: `
    <div class="page">
      <div class="page-header">
        <div class="page-icon" style="background:linear-gradient(135deg,#06b6d4,#22d3ee)">
          <mat-icon>style</mat-icon>
        </div>
        <div>
          <h1 class="page-title">Flashcards</h1>
          <p class="page-sub">Quản lý bộ thẻ học của bạn</p>
        </div>
      </div>
      <div class="empty-card">
        <div class="empty-icon" style="background:linear-gradient(135deg,rgba(6,182,212,0.12),rgba(34,211,238,0.08))">
          <mat-icon style="color:#06b6d4">style</mat-icon>
        </div>
        <p class="empty-title">Tính năng đang phát triển</p>
        <p class="empty-desc">Tạo và quản lý bộ thẻ flashcard thông minh với AI sẽ sớm ra mắt.</p>
      </div>
    </div>
  `,
})
